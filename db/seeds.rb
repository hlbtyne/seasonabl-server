...
#     url = "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/findByIngredients?number=5&ignorePantry=true&ingredients=#{food.name}"
...
#         element = {title: recipe["title"], api_id: recipe["id"], missedIngredients: recipe["missedIngredients"], usedIngredients: recipe["usedIngredients"]}
#         result << element
#     end
#     result.each do |recipe|
#         recipe = Recipe.create(title: recipe[:title], api_id: recipe[:api_id])
